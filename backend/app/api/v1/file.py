...
async def upload_single(
    ...
    return APIResponse(code=200, message="上传成功", data=file_info)
...
def merge_chunks(
    ...
    return APIResponse(code=200, message="合并成功", data=file_info)
...
def download_file(
    ...
    return file_service.download_file(db, file_id)
...
def download_batch(
    ...
    return file_service.download_batch_files(db, file_ids, current_user.id, current_user.role)
...
def rename_file(
    ...
    file = file_service.rename_file(db, file_id, name)
